    ...
    <nav className="bg-emerald-600 text-white shadow-md">
      <div className="flex flex-wrap items-center justify-between mx-auto px-4 md:px-12 h-16">
        <a href="/" className="flex items-center text-white font-bold text-2xl">
          <span className="text-green-500"><Leaf className="w-6 h-6 text-white mr-2" /></span> Farmigo
        </a>
        <div className="flex flex-row gap-4 md:gap-8 text-lg md:text-xl">
          ...
          >
            ...
            {cookies.user_access_token && (
              <div
                className={`absolute ${showUserDropdown ? "block" : "hidden"} top-12 right-0 z-50 bg-white text-gray-800 shadow-lg rounded-lg py-2 px-4 min-w-[160px]`}
              >
          ...
          >
            ...
            {cookies.seller_access_token && (
              <div
                className={`absolute ${showSellerDropdown ? "block" : "hidden"} top-12 right-0 z-50 bg-white text-gray-800 shadow-lg rounded-lg py-2 px-4 min-w-[160px]`}
              >
                <ul className="text-sm">
                  <li
                    onClick={(e) => {
